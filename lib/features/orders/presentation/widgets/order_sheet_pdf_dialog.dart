...
Future<void> showOrderSheetPdfDialog(
  ...
  if (rows.isEmpty) {
    ...
    showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(l10n.ordersContextMenuGenerateOrderSheet),
        content: Text(l10n.ordersGenerateOrderSheetEmpty),
        actions: [
          TextButton(
  ...
  try {
    final pdfBytes = await sl<OrderSheetPdfGenerator>().generate(
      ...
      rows: rows,
      labels: OrderSheetPdfLabels(
        client: l10n.ordersPdfLabelClient,
        dateTime: l10n.ordersPdfLabelDateTime,
        orderNumber: l10n.ordersPdfLabelOrderNumber,
        product: l10n.ordersPdfLabelProduct,
        quantity: l10n.ordersPdfLabelQuantity,
        notes: l10n.ordersPdfLabelNotes,
        shippingMethod: l10n.ordersPdfLabelShippingMethod,
        totalProducts: l10n.ordersPdfLabelTotalProducts,
        subtotal: l10n.ordersPdfLabelSubtotal,
      ),
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text(l10n.ordersErrorUnknown)));
  }
}
...
Future<String?> _resolveShippingMethod(
  ...
  final clientsResult = await sl<GetClients>()(NoParams());
  final shippingMethodsResult = await sl<GetShippingMethods>()(NoParams());

  final shippingMethods = shippingMethodsResult.getOrElse(
    (_) => <ShippingMethod>[],
  );
