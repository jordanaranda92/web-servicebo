...
class _ClientCategoryFilterDialogState
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(l10n.ordersFilterClientsDialogTitle),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CheckboxListTile(
                              ...
                              title: Text(
                                l10n.ordersFilterNoCategoryLabel,
                                style: textTheme.bodyMedium?.copyWith(
      ...
      actions: [
        OutlinedButton(
          ...
          child: Text(l10n.ordersFilterCancel),
        ),
        if (hasCategories)
          FilledButton(
